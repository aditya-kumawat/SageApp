...
# This file was *autogenerated* from the file SageCodes/MapToGroup.sage
from sage.all_cmdline import *   # import sage library

_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_159 = Integer(159)
import hashlib
import warnings
...
def map_to_group ( self , m , n , msg , r ) :
	...
	if(not self.a1==_sage_const_0  and self.a3==_sage_const_0 ):
	...
	while i<=s :
		...
		t= int(msg_hash_bit_str[:-_sage_const_1 ] , _sage_const_2  )%nn
		...
		b = Integer(msg_hash_bit_str[_sage_const_159 ])
		f = x**_sage_const_3  + self.a2()*x**_sage_const_2  + self.a4()*x + self.a6()
